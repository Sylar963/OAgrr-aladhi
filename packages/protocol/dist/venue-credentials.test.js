...
import { VenueCredentialsSchema, VenuePrivateAdapterSpecSchema, PRIVATE_ADAPTER_SPECS, } from './venue-credentials.js';
describe('VenueCredentialsSchema', () => {
    ...
    it('rejects an unknown field key', () => {
        expect(VenueCredentialsSchema.safeParse({ ...valid, fields: { totallyMadeUp: 'x' } }).success).toBe(false);
    });
...
//# sourceMappingURL=venue-credentials.test.js.map