...
export const VENUES: Record<string, VenueMeta> = {
  deribit: { id: "deribit", label: "Deribit",  shortLabel: "DER", logo: deribitLogo, color: "#0052FF" },
  okx:     { id: "okx",     label: "OKX",      shortLabel: "OKX", logo: okxLogo,     color: "#888888" },
  binance: { id: "binance", label: "Binance",  shortLabel: "BIN", logo: binanceLogo, color: "#F0B90B" },
